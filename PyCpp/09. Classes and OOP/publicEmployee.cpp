...
public:
    void inviteTalk() {
        cout << "Can you give a talk nexe week?" <<endl;
    }
    void giveTalk() {
...
public:
    PublicEmployee(int id, string frnm, string lnm, double sal) :
    Employee(id, frnm, lnm, sal) {
...
int main() {
    ...
    PublicEmployee* pemp = new PublicEmployee(id++, "Elizabeth", "Impressive",6000);
    pemp->inviteTalk();
