    ...
    : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition)
{
   ...
   // grid = new wxGrid(rightPanel, wxID_ANY, wxDefaultPosition, wxSize(150, 160));
   // advSzr->Add(grid);
    //advList = new GridAdapter(grid);
    advcList = new GridAdapterClass(rightPanel, wxID_ANY, wxDefaultPosition, wxSize(150, 160));
    advSzr->Add(advcList);
    ...
    advcList->Bind(wxEVT_GRID_SELECT_CELL, &StudentFrame::advClick, this);

    //The middle panel contains 2 buttons
    wxBoxSizer* bxs = new wxBoxSizer(wxVERTICAL);
    midPanel->SetSizer(bxs);
    med = new Mediator(this, studentList, advcList);
    bxs->AddSpacer(10);
