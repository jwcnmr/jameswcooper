...
public:
    ...
    void advClick(wxGridEvent& event);
    wxPoint* pt;
};
...
bool StudentApp::OnInit()
{
    ...
    StudentFrame* gframe = new StudentFrame(wxT("Student selection"));
    gframe->Show(true);
    return true;
}
    ...
    : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition)
{
    ...
    advGrid = new wxGrid(rightPanel, wxID_ANY, wxDefaultPosition, wxSize(150, 160));
   
    advList = new GridAdapter(advGrid);
    advSzr->Add(advGrid);
    ...
    advGrid->Bind(wxEVT_GRID_SELECT_CELL, &StudentFrame::advClick, this);
...
void StudentFrame::advClick(wxGridEvent& event) {
